...
示例版本 **3.3.5**，安装包与镜像以 [GitHub Releases](https://github.com/fluxsce/gateway/releases) 最新版为准。
...
| `gateway-linux-arm64-3.3.5.tar.gz` | Linux arm64 | 同上 |
| `gateway-windows-amd64-3.3.5.zip` | Windows amd64 | 同上 |
| `gateway-linux-amd64-oracle-3.3.5.tar.gz` | Linux amd64 | 上表 + Oracle |
| `gateway-windows-amd64-oracle-3.3.5.zip` | Windows amd64 | 上表 + Oracle |
