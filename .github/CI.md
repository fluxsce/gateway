...
CI 用 `GITHUB_TOKEN` 推送（以 `3.2.5` 为例）：

```text
ghcr.io/fluxsce/gateway:3.2.5
ghcr.io/fluxsce/gateway:3.2.5-amd64
ghcr.io/fluxsce/gateway:3.2.5-arm64
ghcr.io/fluxsce/gateway:3.2.5-oracle
# 仅 git tag 发布时还有：
...
# 指定架构
docker pull ghcr.io/fluxsce/gateway:3.2.5-arm64
docker pull ghcr.io/fluxsce/gateway:3.2.5-amd64
...
CI 在 Secrets 配好后推送到（以 `3.2.5` 为例）：

```text
crpi-25xt72cd1prwdj5s.cn-hangzhou.personal.cr.aliyuncs.com/datahub-images/gateway:3.2.5
crpi-25xt72cd1prwdj5s.cn-hangzhou.personal.cr.aliyuncs.com/datahub-images/gateway:3.2.5-amd64
crpi-25xt72cd1prwdj5s.cn-hangzhou.personal.cr.aliyuncs.com/datahub-images/gateway:3.2.5-arm64
crpi-25xt72cd1prwdj5s.cn-hangzhou.personal.cr.aliyuncs.com/datahub-images/gateway:3.2.5-oracle
# 仅 git tag 发布时还有：
...
# 指定架构
docker pull crpi-25xt72cd1prwdj5s.cn-hangzhou.personal.cr.aliyuncs.com/datahub-images/gateway:3.2.5-arm64
docker pull crpi-25xt72cd1prwdj5s.cn-hangzhou.personal.cr.aliyuncs.com/datahub-images/gateway:3.2.5-amd64
