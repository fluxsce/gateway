...
export function useServiceDefinitionModel() {
  ...
  const serviceFormConfig = {
    ...
    fields: [
      ...
      // ============= 基本信息 Tab（fieldset 分组）=============
      {
        field: 'service-identity-fieldset',
        label: '服务标识',
...

      {
        ...
        children: [
          ...
          },
          {
            ...
            placeholder: '/health',
            span: 12,
            show: (formData: Record<string, any>) => formData.healthCheckEnabled === 'Y',
            defaultValue: '/health',
