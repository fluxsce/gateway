...
export default {
  systemMonitoring: {
    ...
    loadingMonitor: 'Loading server monitoring data, please wait...',
    selectServerHint: 'Please select a server to view monitoring data',
    ...
    loadMonitorFailed: 'Failed to load server monitoring data',
    initFailed: 'Failed to load monitoring data. Please refresh and try again',
    loadMonitorSuccess: 'Server monitoring data loaded successfully',
    refreshAllSuccess: 'All monitoring data refreshed successfully',
    refreshAllFailed: 'Failed to refresh monitoring data',
    refreshCpuSuccess: 'CPU data refreshed successfully',
    refreshMemorySuccess: 'Memory data refreshed successfully',
    refreshDiskSuccess: 'Disk data refreshed successfully',
    refreshNetworkSuccess: 'Network data refreshed successfully',
    refreshDiskIOSuccess: 'Disk I/O data refreshed successfully',
    refreshProcessSuccess: 'Process data refreshed successfully',
  },
  ...
  diskIO: {
    ...
    readBytesRate: 'Read Rate',
    writeBytesRate: 'Write Rate',
  ...
  network: {
    ...
    interfaceDetail: 'Interface Details',
    errors: 'Errors',
  },
