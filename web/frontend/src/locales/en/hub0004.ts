/**
 * Audit Log module English locale
 * hub0004 - Audit Log
 */
export default {
  ...
  module: {
    hub0000: 'System Monitoring',
    hub0001: 'Login',
    hub0002: 'Users',
    hub0003: 'Scheduled Tasks',
    hub0004: 'Audit Log',
    hub0005: 'Roles',
    hub0006: 'Resources',
    ...
    hub0021: 'Routes',
    hub0022: 'Proxies',
    hub0023: 'Gateway Logs',
    hub0040: 'Service Center',
    hub0041: 'Namespaces',
    hub0042: 'Services',
    hub0043: 'Config Center',
    hub0060: 'Tunnel Servers',
    hub0061: 'Static Mapping',
    hub0062: 'Tunnel Clients',
    hub0080: 'Alert Config',
    hub0081: 'Alert Templates',
    hub0082: 'Alert Logs',
    hubplugin: 'Plugins',
  },
  ...
  search: {
    ...
    action: 'Action',
    actionPlaceholder: 'Please select an action',
    moduleCode: 'Module',
    moduleCodePlaceholder: 'Please select a module',
    userName: 'Operator',
    userNamePlaceholder: 'Please enter username',
    userId: 'User ID',
    userIdPlaceholder: 'Please enter user ID',
    targetType: 'Target Type',
    targetTypePlaceholder: 'Please select a target type',
    targetName: 'Target Name',
    targetNamePlaceholder: 'Please enter target name',
    targetId: 'Target ID',
    targetIdPlaceholder: 'Please enter target ID',
    resourceCode: 'Resource Code',
    resourceCodePlaceholder: 'Please enter resource code',
    result: 'Result',
    resultPlaceholder: 'Please select a result',
    clientIP: 'Client IP',
    clientIPPlaceholder: 'Please enter client IP',
  },
  ...
  dialog: {
    ...
    titleWithId: 'Audit Log Details - {id}',
  ...
  message: {
    auditIdRequired: 'Audit ID is required',
