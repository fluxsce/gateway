/**
 * English - hub002 User Management Module Language Pack
 */
export default {
  userManagement: {
    title: 'User Management',
    subtitle: 'Manage system users, assign roles and permissions',
    addUser: 'Add User',
    editUser: 'Edit User',
  ...
  profile: {
    ...
    realNameLength: 'Real name must be between 2-50 characters',
    email: 'Email',
    ...
    avatarSizeLimitBase64: 'Avatar size cannot exceed 500KB (base64 storage limit)',
    avatarTypeInvalid: 'Invalid avatar format, only JPG, PNG, GIF are supported',
    avatarPreviewSuccess: 'Avatar preview successful, click Save button to complete update',
    avatarPreviewTip: 'Preview mode, click "Save" button to confirm changes, or "Cancel" to discard',
  },
  // Change Password
  password: {
    ...
    passwordLength: 'Password must be between 8-20 characters',
  ...
  settings: {
    ...
    showGuideDesc: 'Show operation guide on first use',
  },
  // Account Information
  account: {
    userId: 'User ID',
    ...
    userExpireDate: 'Account Expiration Date',
  },
  validation: {
  ...
  messages: {
    ...
    noUserSelected: 'Please select users to delete first',
