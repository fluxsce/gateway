...
Examples use **3.2.9**. Prefer the latest assets on [GitHub Releases](https://github.com/fluxsce/gateway/releases).
...
| `gateway-linux-arm64-3.2.9.tar.gz` | Linux arm64 | same |
| `gateway-windows-amd64-3.2.9.zip` | Windows amd64 | same |
| `gateway-linux-amd64-oracle-3.2.9.tar.gz` | Linux amd64 | above + Oracle |
| `gateway-windows-amd64-oracle-3.2.9.zip` | Windows amd64 | above + Oracle |
