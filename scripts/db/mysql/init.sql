...
-- 建表不写 CHARSET/COLLATE，继承当前库的字符集与排序规则。
-- 建库时按环境指定，例如 utf8mb4 / utf8mb4_unicode_ci，或企业要求的 utf8 / utf8_bin。
-- =====================================================
...
source HUB_GW_STATIC_HOST_CONFIG.sql;
...
source HUB_AUTH_AUDIT_LOG.sql;
source HUB_CLUSTER_NODE.sql;
