...
ALTER TABLE HUB_GW_ROUTE_CONFIG ADD COLUMN backendType TEXT DEFAULT 'proxy';
UPDATE HUB_GW_ROUTE_CONFIG SET backendType = 'proxy' WHERE backendType IS NULL OR backendType = '';
ALTER TABLE HUB_GW_ROUTE_CONFIG ADD COLUMN redirectStatus INTEGER DEFAULT 0;
ALTER TABLE HUB_GW_ROUTE_CONFIG ADD COLUMN redirectLocation TEXT;