...
SELECT 'hub0004', 'default', '审计日志', 'hub0004', 'MODULE',
       '/system/auditLogManagement', 'group0001', 2, 7, 'ShieldCheckmarkOutline', 'zh-CN',
       'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_009', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0004'
);
...
SELECT 'hub0004:view', 'default', '查看详情', 'hub0004:view', 'BUTTON',
       'hub0004', 3, 1, 'zh-CN', 'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_009_001', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0004:view'
);
...
SELECT 'hub0004:search', 'default', '查询', 'hub0004:search', 'BUTTON',
       'hub0004', 3, 2, 'zh-CN', 'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_009_002', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0004:search'
);
...
SELECT 'hub0004:reset', 'default', '重置', 'hub0004:reset', 'BUTTON',
       'hub0004', 3, 3, 'zh-CN', 'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_009_003', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0004:reset'
);
...
WHERE r.tenantId = 'default'
  AND r.resourceId IN ('hub0004', 'hub0004:view', 'hub0004:search', 'hub0004:reset')
  AND NOT EXISTS (
