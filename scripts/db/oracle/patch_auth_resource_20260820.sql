...
SELECT 'hub0020:securityConfig', 'default', '安全配置', 'hub0020:securityConfig', 'BUTTON',
       'hub0020:globalConfig', 4, 8, 'zh-CN', 'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_010_011_SEC', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0020:securityConfig'
);
...
SELECT 'hub0021:securityConfig', 'default', '安全配置', 'hub0021:securityConfig', 'BUTTON',
       'hub0021:routeConfig', 4, 20, 'zh-CN', 'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_011_013_SEC', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0021:securityConfig'
);
...
SELECT 'hub0022:securityConfig', 'default', '安全配置', 'hub0022:securityConfig', 'BUTTON',
       'hub0022', 3, 10, 'zh-CN', 'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_012_010', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0022:securityConfig'
);
...
SELECT 'hub0082:edit', 'default', '更新日志', 'hub0082:edit', 'BUTTON',
       'hub0082', 3, 5, 'zh-CN', 'Y', 'Y',
       SYSDATE, 'system', SYSDATE, 'system', 'INIT_042_005', 1, 'Y'
FROM DUAL
WHERE NOT EXISTS (
  SELECT 1 FROM HUB_AUTH_RESOURCE WHERE tenantId = 'default' AND resourceId = 'hub0082:edit'
);
