...
-- 新增索引
CREATE INDEX idx_HUB_TIMER_TASK_executorType ON HUB_TIMER_TASK(executorType);
CREATE INDEX idx_HUB_TIMER_TASK_toolConfigId ON HUB_TIMER_TASK(toolConfigId);
CREATE INDEX idx_HUB_TIMER_TASK_operationType ON HUB_TIMER_TASK(operationType);
