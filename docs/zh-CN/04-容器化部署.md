...
gateway-app       datahub-images/gateway:2.0.2   Up (healthy)   0.0.0.0:18280->8080/tcp, ...
```
...
# 或使用 Docker Hub 镜像
# image: datahub-images/gateway:2.0.2
```
...
| 版本 | 标签 | 说明 | 大小 |
|------|------|------|------|
| **标准版** | `2.0.2` | 支持 MySQL、SQLite | ~50MB |
| **Oracle 版** | `2.0.2-oracle` | 支持 MySQL、SQLite、Oracle | ~300MB |
