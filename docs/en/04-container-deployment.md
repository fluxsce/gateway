...
Images are published by GitHub Actions. Details: [.github/CI.md](../../.github/CI.md). Examples use **3.4.5**.
...
Tags: `3.4.5` (amd64+arm64), `3.4.5-amd64`, `3.4.5-arm64`, `3.4.5-oracle` (amd64 only, Instant Client included), `latest` (git-tag releases only).
...
Default image in compose is `ghcr.io/fluxsce/gateway:3.4.5`. Switch the `image:` field for ACR.
