...
Images are published by GitHub Actions. Details: [.github/CI.md](../../.github/CI.md). Examples use **3.4.0**.
...
Tags: `3.4.0` (amd64+arm64), `3.4.0-amd64`, `3.4.0-arm64`, `3.4.0-oracle` (amd64 only, Instant Client included), `latest` (git-tag releases only).
...
Default image in compose is `ghcr.io/fluxsce/gateway:3.4.0`. Switch the `image:` field for ACR.
